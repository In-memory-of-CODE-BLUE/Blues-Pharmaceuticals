...
function ENT:Initialize()
	self:SetModel("models/blues_pharm/jar_3.mdl")
	...
	self:SetAngles(self:GetAngles() + Angle(0,130,0))

	--Allow destuction
	self:SetHealth(25)

	--Set liquid anount (ml)
	self:SetLiquidAmount(1000)

	--Stores who currently has this jar selected
	self.playerWhoSelected = nil

	self:SetSubMaterial(0, "blues_pharm/jar_3_plastic_17alph")
	self:SetSubMaterial(2, "blues_pharm/jar_3_label_17alph")
