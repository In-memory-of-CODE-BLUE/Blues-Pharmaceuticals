...
function ENT:Initialize()
	self:SetModel("models/blues_pharm/jar_1.mdl")
	...
	self:SetLiquidAmount(500)

	--Stores who currently has this jar selected
	self.playerWhoSelected = nil

	self:SetSubMaterial(0, "blues_pharm/jar_1_keto_acid_glass")
	self:SetSubMaterial(2, "blues_pharm/jar_1_label_keto_acid")
